<?php
function htw_set_linkcolor($css, $linkcolor) {
...
function htw_set_linkhover($css, $linkhover) {
...
function htw_set_maincolor($css, $maincolor) {
...
function htw_set_maincolorlink($css, $maincolorlink) {
...
function htw_set_headingcolor($css, $headingcolor) {
...
function htw_set_logo($css, $logo) {
 global $OUTPUT;
 $tag = '[[setting:logo]]';
 $replacement = $logo;
 if (is_null($replacement)) {
...
function htw_process_css($css, $theme) {
    ...
    $css = htw_set_linkcolor($css, $linkcolor);
...
// Set the link hover color
    ...
    $css = htw_set_linkhover($css, $linkhover);
    ...
    $css = htw_set_maincolor($css, $maincolor);
    ...
    $css = htw_set_maincolorlink($css, $maincolorlink);
   ...
   // Set the main headings color
    ...
    $css = htw_set_headingcolor($css, $headingcolor);
