...
/**
 * Strings for component 'theme_htw', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   moodlecore
...
<div class="theme_screenshot">
	...
	<h2 style="padding-top:0.5em;">htw</h2>
	<img src="htw/pix/screenshot.png" />
...
<div class="theme_description">
	...
	<h2>About</h2>
	<p>htw is a two-column, fluid-width theme for Moodle 2.0. You can change the theme color scheme via the theme settings page.</p>
...
$string['configtitle'] = 'htw settings';
