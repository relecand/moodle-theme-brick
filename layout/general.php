...
<div id="page-header">
	...
	<div id="header" >
        <div style="float:left">
            <a title="Zu meiner Startseite" href="<?php echo $CFG->wwwroot ?>"><img style="height:94px" alt="Zu meiner Startseite" src="<?php echo $CFG->wwwroot ?>/theme/image.php?theme=htw&component=theme&image=logohtwmoodle" /></a>
        </div>
